...
const ThemeToggle = () => {
  ...
  return (
    <div className="fixed top-6 right-6 z-50 flex items-center gap-3 bg-white/20 dark:bg-black/20 backdrop-blur-md border border-sage-accent/30 dark:border-emerald-accent/20 rounded-full px-4 py-2 shadow-lg">
